import { evaluate } from "../../prispevky/prispevok_na_komenzaciu_zvysenych_nakladov_hygiena.js";
import { loadJsonSync, assert, deepEqual } from "../../test_util.js";

const RESOURCES = "tests/prispevok_na_komenzaciu_zvysenych_nakladov_hygiena/resources";
const date = new Date("2024-01-01T00:00:00Z");

const client1 = loadJsonSync(`${RESOURCES}/client_1.json`);
const result1 = evaluate(client1, date);
assert(deepEqual(result1, { isEntitled: true, customData: { totalAmount: 25.43, amountPerPerson: 25.43, numberOfPersons: 1 } }));
